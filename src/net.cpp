...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cobilcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cobilcoin.com", "45.55.190.206"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"cobilcointools.com", "testnet-seed.cobilcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cobilcoin is probably already running."), addrBind.ToString().c_str());
        else
